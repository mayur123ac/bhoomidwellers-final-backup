...
export async function POST(
    ...
    try {
        ...
        const trancheRes = await query(
         ...
         (lead_id, amount, status, receiving_date, bank_reference_no, remarks, added_by_name, added_by_role)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
       RETURNING *`,
            [Number(id), cleanAmount, status || "Pending", receiving_date || null, bank_reference_no || null, remarks || null, user_name || null, user_role || null]
        );
        ...
        return NextResponse.json({ success: true, tranche, totalDisbursed }, { status: 200 });
    } catch (err: any) {
