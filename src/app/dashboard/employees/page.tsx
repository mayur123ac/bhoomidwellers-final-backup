          ...
          <div className="flex flex-1 h-full overflow-hidden">
            ...
            <div className={`flex-1 flex flex-col h-full overflow-hidden transition-colors duration-300 ${t.rightPanel}`}>
              ...
              {callerSubView === "detail" && selectedLead ? (
                <div className={`flex-1 overflow-y-auto p-2 animate-fadeIn ${t.scroll}`}>
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        {[
                          ...
                          <div key={label} className="flex justify-between items-start">
                            ...
                            <p className={`font-medium max-w-[60%] text-right break-words ${t.text}`}>{value}</p>
                          </div>
                        ) : null)}
                        <div className="flex justify-between items-start">
                          <div className="w-full">
                ...
                <div className={`flex-1 overflow-y-auto p-2 ${t.scroll}`}>
  ...
  return (
    <div className="flex flex-1 h-full overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-2 bg-[#0a0a0a] custom-scrollbar">
