...
// components/receptionist/ReceptionistMobileDrawer.tsx
//
// The Receptionist Panel's hamburger sidebar for mobile screens.
//
// Direct port of components/admin/AdminMobileDrawer.tsx — same drawer-from-right
// pattern, same backdrop, same animation, same close behaviour (Escape key,
// backdrop click, x button, body-scroll lock). The only differences are:
//   - It receives the Receptionist's RECEPTIONIST_NAV items.
//   - It shows "Receptionist" as the role label.
//
// Desktop: this component is never mounted — the ReceptionistSidebar handles
...
import type { ReceptionistNavItem } from "@/components/receptionist/ReceptionistSidebar";

export default function ReceptionistMobileDrawer({
  open,
  onClose,
  activeId,
  onSelect,
  ...
  const renderItem = (item: ReceptionistNavItem) => {
